...
enum{FIRSTREPORT,
#ifdef KLIMASENSOR
TEMPREPORT,HUMIREPORT,ABSHUMIREPORT,DEWPOINTREPORT,
#endif // KLIMASENSOR
DS18B20REPORT,
HEAT_ACTUAL_STATUS_REPORT,HEAT_SET_STATUS_REPORT,
HEAT_SWELL_REPORT,HEAT_NIGHT_SWELL_REPORT,HEAT_HYSTERESE_REPORT,
LASTREPORT};
